...
### 🏠 타이머 목록
- 새로운 타이머 추가 및 기존 타이머 편집
- 타이머 리스트 확인

### ⏱️ 타이머 실행
- 공부 모드
    - 목표 시간과 총 공부 시간 동시 표시
    - ProgressBar 애니메이션
    - 목표 달성 시 라벨/progress 등 색상 변경
- 휴식 모드
    - 기본 휴식시간 5분 카운트다운 및 섹션에서 총 휴식 시간 제공
    - +1분/+5분/+10분 버튼으로 시간 연장 가능
    - 휴식 시간은 휴식 섹션마다 초기화
<!-- - 알림: 타이머 종료 시 알림 소리 On/Off 지원 -->

### 📊 통계
- 일간/주간/월간 공부/휴식 시간 데이터 시각화
- 카테고리별 통계 및 패턴 분석 지원

### ⚙️ 설정
<!-- - 타이머 알림 소리 On/Off 저장 (UserDefaults) -->
