...
enum NotificationScheduler {
  ...
  private static func removePending(_ center: UNUserNotificationCenter, id: String) {
  ...
  static func scheduleEnd(
    ...
    // 중복방지: 일시정지, 종료시간 재계산 등 타이머가 다시 예약되면, 아직 울리지 않은 identifier(여기서는 id)를 가진 예약을 취소
    removePending(center, id: id)
